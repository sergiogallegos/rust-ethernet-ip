...
|---|---|---|---|---|---|
| CODEX-AG | cross_language_compatibility_tests — honor SKIP_PLC_TESTS + TEST_PLC_ADDRESS, migrate to gTest* tag set | codex | open | 2026-05-25 claude [Opus 4.7] | [`tasks/CODEX-AG-cross-language-tests-env-vars.md`](tasks/CODEX-AG-cross-language-tests-env-vars.md) |
