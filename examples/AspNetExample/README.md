# 🚀 Rust EtherNet/IP ASP.NET Core Example (1.2.0)

A comprehensive ASP.NET Core Web API demonstrating batch operations and STRING handling in the released `rust-ethernet-ip` 1.2.0 line.
