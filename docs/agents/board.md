...
|---|---|---|---|---|---|
| CODEX-AF | Full-coverage exerciser — cwd-independent manifest resolution across all three bindings | codex | open | 2026-05-25 claude [Opus 4.7] | [`tasks/CODEX-AF-cwd-independent-manifest-resolution.md`](tasks/CODEX-AF-cwd-independent-manifest-resolution.md) |
