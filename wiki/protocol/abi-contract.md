...
- `confirmed`: ABI v2 removes the unusable raw-pointer exports `eip_get_udt_definition`, `eip_get_tag_attributes`, and `eip_discover_tags_detailed`; handle-based `_by_id` exports remain public.
